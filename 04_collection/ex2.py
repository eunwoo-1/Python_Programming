...
result = ori.copy()  # 원본을 바꾸고 싶지 않을 때 사본을 이용한다
result.append(10)
...
result[0].append(10)
print(ori, result)  # 얕은 복사여서 같은 주소값을 가리킴 - 원본이 같이 바뀜
...
# print([zip(subjects, scores)])         이건 안 됨
...
std1 = scores[0]        # [90, 80, 70]
std2 = scores[1]        # [100, 90, 80]
std3 = scores[2]        # [80, 70, 60]
