...
reuslt = {v: k for k, v in result.items()}
print(result)
...
subjects = ["국어", "영어", "수학"]
grades = [90, 80, 100]
result = {subjects[i]: grades[i] for i in range(len(subjects))}
...
result = {k: v for k, v in stock.items()}
result.update(incoming)
print(result)                                    # ✅ {'연필': 10, '지우개': 9, '노트': 10, '볼펜': 12}
